...
<html lang="en">
    <head>
        ...
        <title>User Info | Registration and Login System</title>
                            ...
                            <?php
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        $ret = mysqli_query($conn, "SELECT * FROM user_info");
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="code.php" method="POST">   
                                                    <input type="hidden" name="dltinfo_id" value="<?php echo $row['id'];?>">
                                                    <button type="submit" class="btn" name="dltinfo_btn"><i class="fa fa-trash"></i></button>
                                                </form>
                                            </td>
                                        </tr>
                                        <?php 
