                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                  ...
                                  <th>Action</th>
                                    ...
                                    <tbody>
                                    <?php 
// Check if search key is set
if(isset($_POST['searchkey'])) {
    $searchkey = mysqli_real_escape_string($con, $_POST['searchkey']); // Sanitize input
    $ret = mysqli_query($con, "SELECT * FROM users WHERE (fname LIKE '%$searchkey%' OR email LIKE '%$searchkey%' OR contactno LIKE '%$searchkey%')");
    $cnt = 1;
    ?>
    <table id="datatablesSimple">
        <thead>
