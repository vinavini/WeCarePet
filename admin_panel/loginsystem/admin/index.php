...
<html lang="en">
    ...
    <body style="background-color: hsl(257,68%,73%);">
...
<!-- <a class="small" href="password-recovery.php">Forgot Password?</a> -->&nbsp
<button class="btn btn-primary block" name="login" type="submit" >Login</button>
</div>
</form>
</div>
